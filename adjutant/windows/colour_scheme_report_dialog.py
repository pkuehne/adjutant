...
from adjutant.reports.colour_scheme_report import ColourSchemeReport


class ColourSchemeReportDialog(QDialog):
    """Dialog for choosing colour scheme"""
    ...
    def __init__(self, context: Context, parent, index=None) -> None:
        ...
        self.setWindowTitle("Colour Scheme Report")
    ...
    def _setup_layout(self):
        ...
        options_layout.addRow(self.tr("Colour Scheme"), self.scheme_combobox)
    ...
    def generate_report(self):
        ...
        report = ColourSchemeReport(self.context, scheme_id)
        report.prepare()
        report.generate()
        self.close()
